...
/**
 * <p/>
 * <li>Description: NIO编程 server端</li>
 * <li>@author: lipan@cechealth.cn</li>
 * <li>Date: 2019-05-17 15:38</li>
 */
public class NioServer implements Runnable {

    /**
     * 服务端所有的channel注册到一个Selector多路复用器上， 选择器。 用于注册通道的。
     */
    ...
    public void run() {
        while (true) {
            try {
                 ...
                 * 多路复用器进行轮询：通道是否选择，由注册到多路复用器中的通道标记决定。
                 */
